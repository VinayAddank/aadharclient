 ...
 * 
 */
@WebServiceClient(name = "Services", targetNamespace = "http://services/ecentric/com/", wsdlLocation = "file:/wsdl/Services3.xml")
    ...
    extends Service
{
    ...
    private final static QName SERVICES_QNAME = new QName("http://services/ecentric/com/", "Services");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = Services.class.getResource("/wsdl/Services3.xml");
            //url = new URL("http://ekyc.ap.gov.in/SRDHekycpidService/services/Services?wsdl");
        } catch (Exception e1) {
            e = new WebServiceException(e1);
            logger.error("Failed to create URL for the wsdl Location: '/wsdl/Services3.xml'.");
    ...
    public ServicesPortType getServicesSOAP11PortHttp() {
        return super.getPort(new QName("http://services/ecentric/com/", "ServicesSOAP11port_http"), ServicesPortType.class);
    }
    ...
    public ServicesPortType getServicesSOAP11PortHttp(WebServiceFeature... features) {
        return super.getPort(new QName("http://services/ecentric/com/", "ServicesSOAP11port_http"), ServicesPortType.class, features);
    }

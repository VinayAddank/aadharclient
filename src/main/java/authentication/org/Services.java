 ...
 * 
 */
@WebServiceClient(name = "Services", targetNamespace = "http://authentication/org/", wsdlLocation = "file:/wsdl/Services2.xml")
    ...
    extends Service
{
    ...
    private final static QName SERVICES_QNAME = new QName("http://authentication/org/", "Services");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = Services.class.getResource("/wsdl/Services2.xml");
//            url = new URL("http://164.100.132.195:8010/SRDHSecuredVerificationServices/services/Services?wsdl");
        } catch (Exception e1) {
    ...
    public ServicesPortType getServicesSOAP11PortHttp() {
        return super.getPort(new QName("http://authentication/org/", "ServicesSOAP11port_http"), ServicesPortType.class);
    }
    ...
    public ServicesPortType getServicesSOAP11PortHttp(WebServiceFeature... features) {
        return super.getPort(new QName("http://authentication/org/", "ServicesSOAP11port_http"), ServicesPortType.class, features);
    }
